...
function Resources({ page, pagesLoading, siteSettings }) {
  ...
  return (
    <main className="landing-shell landing-page resources-page">
      <PageHero page={page} siteSettings={siteSettings} />

      {cardsSection ? (
        <section className="content-section resources-board">
